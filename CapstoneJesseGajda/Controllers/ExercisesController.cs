...
namespace CapstoneJesseGajda
{
    ...
    public class ExercisesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ExerciseID,Exercise_Name")] Exercises exercises)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExerciseID,Exercise_Name")] Exercises exercises)
        {
